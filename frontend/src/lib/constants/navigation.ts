...
export const NAV_ITEMS: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      // F2b entrega "Citas" (tabla + wizard + detalle); F4 suma "Calendario" (grilla
      // semanal/día) y "Mi agenda" del doctor (su semana de citas).
      {
        key: "appointments",
        label: "Citas",
  ...
  },
  {
    ...
    children: [
      // F0 declara SOLO Campañas (lo entrega F1). "Promociones" (F2) y "Usos de
      // promoción" (F3) se agregan en su fase para no dejar links muertos prolongados.
      {
        key: "campaigns",
        label: "Campañas",
