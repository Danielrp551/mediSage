...
identifiers/* anidado). Las fases siguientes agregan lead_status/customer_status
(F2), lead_lifecycle/assignment/activity (F3), customer_lifecycle (F4).
"""
...
# F2: router.include_router(lead_status_router)       # /lead-statuses/* (+ matriz)
# F2: router.include_router(customer_status_router)   # /customer-statuses/* (+ matriz)
