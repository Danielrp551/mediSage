...
> **Códigos de error de dominio** (`detail` en **español**, `code` en inglés): `CAMPAIGN_NOT_FOUND` (404), `CAMPAIGN_CODE_TAKEN` (409), `CAMPAIGN_INVALID_DATES` (400), `TARGET_VERTICAL_NOT_FOUND` (400), `CAMPAIGN_TRANSITION_NOT_ALLOWED` (400), `PROMOTION_NOT_FOUND` (404), `PROMOTION_CODE_TAKEN` (409), `PROMOTION_INVALID_DISCOUNT` (400), `PROMOTION_INVALID_DATES` (400), `PRODUCT_NOT_FOUND` (404), `PERSON_NOT_FOUND` (404), `PROMOTION_PRODUCT_NOT_COVERED` (400), `APPOINTMENT_NOT_FOUND` (404 — apply con `appointment_id` inexistente), `PROMOTION_ALREADY_APPLIED` (409 — no-stacking), `PROMOTION_NOT_ACTIVE` (400), `PROMOTION_EXPIRED` (400), `PROMOTION_LIMIT_REACHED` (400), `PROMOTION_PERSON_LIMIT_REACHED` (400). La tabla completa con el "cuándo" exacto está en [`backend.md`](backend.md).
